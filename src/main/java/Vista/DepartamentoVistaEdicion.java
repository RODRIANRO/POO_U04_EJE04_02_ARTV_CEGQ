    ...
    private void actualizar(){
        ...
        try {
            ...
            if (!jTextFieldGerenteDepartamento.getText().trim().equals("cedula empleado (OPCIONAL)")) {
                ...
                var gerente = departamentoControlador.empleadoServicio.getEmpleadoByCedula(jTextFieldGerenteDepartamento.getText());
                if (gerente != null) {

                    departamentoControlador.asignarGerenteDepartamento(departamentoNuevo.getCodigo(), gerente);
                    // a empleado gerente tambien se le asigna el departamento 
                    departamentoControlador.empleadoServicio.asignarDepartamento(gerente.getCedula(), departamentoNuevo);
